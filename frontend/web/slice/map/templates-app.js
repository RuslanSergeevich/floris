...
angular.module("home/home.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("home/home.tpl.html",
    ...
    "    <input type=\"text\" data-ng-model=\"newMarker\" class=\"form-control\" placeholder=\"Search for...\">\n" +
    "      <span class=\"input-group-btn\">\n" +
    "        <button class=\"btn btn-default\" data-ng-click=\"addMarker()\" type=\"button\">Add</button>\n" +
    "      </span>\n" +
    "\n" +
    "</div>\n" +
    "\n" +
    "<yandex-map style=\"height: 500px;\" center=\"map.center\" zoom=\"map.zoom\">\n" +
