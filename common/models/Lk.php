...
class Lk extends \yii\db\ActiveRecord
{
    ...
    public function attributeLabels()
    {
        return [
            ...
            'publish' => 'АктивированаАктивирована?',
    ...
    public static function addUserLk($email, $phone){
        ...
        if($model->save()){
            ...
            $html .= '<tr>Для получения доступа к оптовым ценам подтвердите свой адрес электронной почты, 
                          перейдя по ссылке <a href="'.\Yii::$app->getUrlManager()->getBaseUrl().'/user-token/login?token='.$token.'" style="color:red">тут ссылка</a><br/><br/></tr>';
