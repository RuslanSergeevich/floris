...
class Weight extends \yii\db\ActiveRecord
{
    ...
    {
        return ArrayHelper::map(ArrayHelper::merge([['id' => '0', 'name' => 'Масса упаковки нетто']],self::find()->where(['publish' => self::PUBLISH])->orderBy('pos ASC')->asArray()->all()),'id','name');
    }
}
