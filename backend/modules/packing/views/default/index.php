    ...
    <div class="col-xs-12">
        <div class="box">
            ...
            <div class="box-body table-responsive no-padding">
                ...
                echo GridView::widget([
                    ...
                    'columns' => [
                        ...
                        [
                            ...
                            'format' => 'html',
                            'value' => function ($model) {
                                return Packing::getStatusesIcon($model->publish);
                            },
                        ],
                        [
                ...
                echo Html::tag('div', Html::a('Добавить', Url::toRoute(['/packing/add']), ['class' => 'btn btn-block btn-primary']), [
                    'class' => 'button-add'
                ]);
                ?>
            </div>
