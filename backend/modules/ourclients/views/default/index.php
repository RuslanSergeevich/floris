    ...
    <div class="col-xs-12">
        <div class="box">
            ...
            <div class="box-body table-responsive no-padding">
                ...
                echo GridView::widget([
                    ...
                    'columns' => [
                        ...
                        [
                            ...
                            'header' => 'Изображение',
                            'value' => function ($model) {
                                return $model->image ? Html::img(\common\models\Ourclients::PATH . $model->image, ['width' => 55]) : '';
                            },
                            'format' => 'html'
                        ],
                        [
                ...
                echo Html::tag('div', Html::a('Добавить', Url::toRoute(['/ourclients/add']), ['class' => 'btn btn-block btn-primary']), [
                    'class' => 'button-add'
                ]);
                ?>
            </div>
